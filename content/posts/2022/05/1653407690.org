...
I consider the Org inactive timestamps title core to the tumblelog flow. Better let [[https://gohugo.io/functions/dateformat/][=time.Format=]] produce something plausible in my `posts.md` Hugo archetype.
